return {
  'kennykaye/mini.files',
  branch = 'kaye/highlight',
  windows = {
    preview = true,
    width_focus = 30,
    width_preview = 30,
  ...
  config = function ()
    require("mini.files").setup({
      content = {
        ...
        filter = function(fs_entry)
          return fs_entry.fs_type ~= 'directory' or fs_entry.name ~= '.git'
        end,
      },
      mappings = {
        close = "q",
    ...
    vim.api.nvim_create_autocmd("User", {
      ...
      callback = function(args)
        ...
        map("n", "gc", files_set_cwd, { buffer = args.data.buf_id, desc = "Set cwd" })
