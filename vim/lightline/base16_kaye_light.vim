" =============================================================================
" Filename: autoload/lightline/colorscheme/base16_kaye_light.vim
" Version: 0.0
" Author: Kenny Kaye
" License: MIT License
" =============================================================================
...
let s:green = [ '#a2bb00', s:cuicolors.green[s:cuiindex] ]
...
let s:p.normal.right = [ [ s:base02, s:base0 ], [ s:base03, s:base01 ] ]
let s:p.inactive.right = [ [ s:base01, s:base02 ], [ s:base01, s:base02 ] ]
let s:p.inactive.left =  [ [ s:base0, s:base02 ], [ s:base1, s:base02 ] ]
let s:p.insert.left = [ [ s:base03, s:green ], [ s:base03, s:base01 ] ]
let s:p.replace.left = [ [ s:base03, s:red ], [ s:base03, s:base01 ] ]
let s:p.visual.left = [ [ s:base03, s:magenta ], [ s:base03, s:base01 ] ]
let s:p.normal.middle = [ [ s:base00, s:base02 ] ]
let s:p.inactive.middle = [ [ s:base01, s:base02 ] ]
let s:p.tabline.left = [ [ s:base02, s:base00 ] ]
let s:p.tabline.tabsel = [ [ s:base1, s:base03 ] ]
let s:p.tabline.middle = [ [ s:base01, s:base1 ] ]
let s:p.tabline.right = copy(s:p.normal.right)
let s:p.normal.error = [ [ s:red, s:base01 ] ]
let s:p.normal.warning = [ [ s:yellow, s:base01 ] ]
let s:p.normal.error = [ [ s:base02, s:magenta ] ]
let s:p.normal.warning = [ [ s:base02, s:yellow ] ]

let g:lightline#colorscheme#base16_kaye_light#palette = lightline#colorscheme#flatten(s:p)
